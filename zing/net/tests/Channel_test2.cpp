/*************************************************************************
	> File Name: Channel_test2.cpp
	> Author: lbw
	> Mail: nuaalbw@163.com 
	> Created Time: Sun 13 Feb 2022 12:58:32 PM CST
 ************************************************************************/
...
class PeriodicTimer
{
 public:
  PeriodicTimer(EventLoop* loop, double interval, const TimerCallback& cb)
    : loop_(loop),
      timerfd_(zing::net::detail::createTimerfd()),
 ...
 private:
  void handleRead()
  {
    ...
    zing::net::detail::readTimerfd(timerfd_, Timestamp::now());
    if (cb_)
      cb_();
  }
